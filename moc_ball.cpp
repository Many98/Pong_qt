...
QT_MOC_LITERAL(1, 5, 11), // "ballMovedUp"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 13), // "ballMovedDown"
QT_MOC_LITERAL(4, 32, 8), // "reflectX"
QT_MOC_LITERAL(5, 41, 8), // "reflectY"
QT_MOC_LITERAL(6, 50, 8), // "changeDY"
QT_MOC_LITERAL(7, 59, 9), // "soundPlay"
QT_MOC_LITERAL(8, 69, 10) // "changeTurn"

    },
    "Ball\0ballMovedUp\0\0ballMovedDown\0"
    "reflectX\0reflectY\0changeDY\0soundPlay\0"
    "changeTurn"
};
...
void Ball::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ballMovedUp(); break;
        case 1: _t->ballMovedDown(); break;
        case 2: _t->reflectX(); break;
        case 3: _t->reflectY(); break;
        case 4: _t->changeDY(); break;
        case 5: _t->soundPlay(); break;
        case 6: _t->changeTurn(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ball::ballMovedUp)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Ball::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Ball::ballMovedDown)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Ball::ballMovedUp()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Ball::ballMovedDown()
{
